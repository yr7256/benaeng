...
function InvalidPage() {
	return (
		<div className="center flex-col h-full text">
			...
			<img className="hidden dark:block" src="/assets/dark/empty-refrigerator.svg" alt="빈 냉장고 아이콘" />
			<img className="dark:hidden block" src="/assets/light/empty-refrigerator.svg" alt="빈 냉장고 아이콘" />
